document.addEventListener('DOMContentLoaded', () => {
    const table = document.getElementById('activeClassroomList'); // Get reference to the table element
    const data = [
    ...
    data.forEach((object, index) => {
      ...
      Object.values(object)
        ...
        checkboxContainer.classList.add('col-lg-2','d-flex','w-75','justify-content-center');
        ...
        isCheckedInput.setAttribute('checked', 'true');
