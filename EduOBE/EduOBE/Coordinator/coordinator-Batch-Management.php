...
<body class="preload">
    <?php
        ...
        // ===========================================  create table
        $createTableQuery = "CREATE TABLE IF NOT EXISTS eduobe.Batch (
        ...
        // ======================================  get data
        $getdata  = "SELECT batch_id, name, num_of_std, starting_date, ending_date, program, bos , semester FROM eduobe.batch";
        ...
        <div class="main container-fluid">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <h3 class="section-heading">Batch Management</h3>

                    <div class="BOS-section row">
                        <div class="section-head">
                            <h4 class="title">List of Batches</h4>
                            <button class="csvBtn">Import CSV</button>
                        </div>
                        <div class="row batch-table">
                            <table id="Batch-dataTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        ...
                                        <th scope="col">Board of Study</th>
                            ...
                            <div class="order-last add-user">
                                <div class="ad-user col-lg-12" data-bs-target="#addBatchModal" data-bs-toggle="modal">
                                    <img id="addBatchBtn" src="../icons/plus-circle.svg" alt="">
                                </div>
                            </div>

                            <div class="modal fade" id="addBatchModal" tabindex="-1"
                                aria-labelledby="addBatchModalLabel" aria-hidden="true" data-bs-backdrop="static">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-content-container">
                                                <form class="me-1" id="addUpdateBatchForm" method="POST">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="batchId" class="form-label">Batch Id</label>
                                                                <input name="batchId" type="text" class="form-control form-animation"
                                                                    id="batchId">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-outline mb-3">
                                                                <label class="form-label" for="NoOfStudents">No of
                                                                    Students</label>
                                                                <input name="numOfStudent" type="number" class="form-control form-animation"
                                                                    id="NoOfStudents">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="startYear" class="form-label">Starting
                                                                    Year</label>
                                                                <input name="startingDate" type="date" class="form-control form-animation"
                                                                    id="startYear">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="endYear" class="form-label">Ending
                                                                    Year</label>
                                                                <input name="endingDate" type="date" class="form-control form-animation"
                                                                    id="endYear">
                                                            </div>
                                                        </div>
                                                        <!-- ===================================================== -->
                                                    <?php
                                                        ...
                                                        $createprogramQuery = "CREATE TABLE IF NOT EXISTS EDUOBE.program (program_code VARCHAR(25) NOT NULL PRIMARY KEY,program_name VARCHAR(100),type VARCHAR(50),number_of_semester varchar(15),program_level VARCHAR(50),assessment_method VARCHAR(100),passing_marks_per VARCHAR(25),learning_type VARCHAR(100))";
                                                        $createprogramStmt = $conn->prepare($createprogramQuery);
                                                        $createprogramStmt->close();
                                                        // ======================================  Create BOS table 
                                                        $createbosQuery ="CREATE TABLE IF NOT EXISTS eduobe.BOS (code VARCHAR(50),name VARCHAR(50),career VARCHAR(500),scheme VARCHAR(50),program VARCHAR(50),isOBE BOOLEAN)";
                                                        $createbosStmt = $conn->prepare($createbosQuery);
                                                        $createbosStmt->close();
                                                    
                                                        // ======================================  get program data 
                                                        $getprogdata = "SELECT program_code FROM eduobe.program";
                                                        $resultprog = $conn->query($getprogdata);
                                                        // ======================================  get BOS data 
                                                        $getbosdata = "SELECT code FROM eduobe.BOS";
                                                        $resultbos = $conn->query($getbosdata);
                                                    
                                                        // Check if there are any rows returned---------------Program
                                                        ...
                                                        // Check if there are any rows returned---------------BOS
                                                    ...
                                                    <!-- ===================================================== -->
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="BOS" class="form-label">Board Of Study</label>
                                                                <select name="BOS" required class="form-select form-animation" id="programLearningType">
                                                                    <option value="" selected>- select -</option>
                                                                    <?php
                                                                        if (!empty($databos)) {
                                                                            foreach ($databos as $row) {
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" id="Batch-modalAddUpdateBtn">Add</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="modal fade" id="deleteBatchConfirmationModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="confirmDeleteBatchBtn" class="btn btn-danger">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="coordinator-Batch-Management.js"></script>
