...
<body class="preload">
    <?php
        ...
        // ======================================  get data
        $getData = "SELECT code, name, delivery_formate, course_level FROM eduobe.courses";
        ...
        $jsonCourseData = json_encode($dataCourse);
        echo "<script>var jsonData = $jsonCourseData;</script>";
    ...
    ?>
    <script>
        var jsonCourseData = <?php echo $jsonCourseData; ?>;
    </script>
        ...
        <div class="main container-fluid">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <h3 class="section-heading">Course Management</h3>

                    <div class="BOS-section row">
                        <div class="section-head">
                            <h4 class="title">List of Courses</h4>
                        ...
                        <div class="row Course-table">
                            <table id="Course-dataTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Delivery Formate</th>
                            ...
                            <div class="order-last add-user">
                                <div id="addCourseBtn" class="ad-user col-lg-12" data-bs-target="#addCourseModal" data-bs-toggle="modal">
                                    <img id="addCourse" src="../icons/plus-circle.svg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Add/Update Courses Modal -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-content-container">
                                    <form id="addUpdateCourseForm" class="me-1" method="POST">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-outline mb-3">
                                                    <label class="form-label" for="deliveryFormat">Delivery
                                                        Format</label>
                                                        <select name="deliveryFormate" required class="form-select form-animation" id="programLearningType">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="courseLevel" required class="form-select form-animation" id="programLearningType">
                                                        <option value="Not Select" selected>- select -</option>
    ...
    <script src="coordinator-Course-Managment.js"></script>
