...
<body class="preload">
    <?php
        ...
        if(isset($_GET['userName'])&isset($_GET['uniLogo'])&isset($_GET['depttLogo'])&isset($_GET['clickedBOSCode'])){
            $userName = $_GET['userName'];
            $uni_logo = $_GET['uniLogo'];
            $deptt_logo = $_GET['depttLogo'];
            $BOScode = $_GET['clickedBOSCode'];
        }
        ...
        // ======================================  get data
        $getdata  = "SELECT semester, term, course_code, course_type, credits FROM eduobe.BOSDetail where BOS_code = '$BOScode'";
        ...
        $BOSCodejsonData = json_encode($BOScode);
        echo "<script>var BOSCodejsonData = $BOSCodejsonData;</script>";
    ...
    <script>
        var BOSDatajsonData = <?php echo $BOSCodejsonData; ?>;
    </script>
            ...
            <div class="bread-crumbs d-flex">
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item selected-BOS"><a href="#"><?php echo $BOScode ?></a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="BOS-section row">
                        <div class="section-head">
                            <h5 class="title">Courses List for BOS <b><span class="selected-BOS"><?php echo $BOScode ?></span></b></h5>
