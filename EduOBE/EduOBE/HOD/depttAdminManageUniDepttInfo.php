...
<body>
    ...
    <div class="sidebar open">
        ...
        <a href="depttAdminManageUniDepttInfo.php?uniLogo=<?php echo $uni_logo;?>&depttLogo=<?php echo $deptt_logo;?>&userName=<?php echo $userName;?>">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-sm-6">
                                                        <div class="mb-3" >
                                                            ...
                                                            <option value="Public">Option 1</option>
                                                            <option value="Government">Option 2</option>
                                                            <option value="Semi Government">Option 3</option>
                                                            <option value="Private">Option 4</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="mb-3" >
                                                            ...
                                                            <option value="Associate Professor">Option 4</option>
                                                            <option value="Senior Associate Professor">Option 5</option>
                                                            <option value="Professor">Option 6</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row deptt-info justify-content-center">
                            ...
                            <?php
                                ...
                                if (!empty($data_deptt)) {
                                    ...
                                    if (!empty($data_uni)) {
                                        echo "<div class='col-lg-9 card Uni-card me-4'>";
